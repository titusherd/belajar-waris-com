          ...
          >
            <div className="sm:col-span-4">
              ...
              <p class="mt-1 text-sm leading-6 text-gray-600">
                Sebab Tidak Mendapat Warisan - Rp 25.000 / tahun
              </p>
            </div>
          </div>
        </div>
...
export default {
  data() {
    return {
      ...
      errorAlert: false,
      price: 25000,
      order_id: "Sebab Tidak Mendapat Warisan",
      status: "",
    };
  },
  methods: {
              ...
              snap.pay(token, {
                onSuccess: (result) => {
                  axios.post("/api/zoho", {
                    ...
                    email: email,
                    apiUrl:
                      "https://flow.zoho.com/839171716/flow/webhook/incoming?zapikey=1001.d2b2ee0a695910ca75126d937b49d060.cb37a19c7815b006b62e2e8248c55651&isdebug=false",
                  });
