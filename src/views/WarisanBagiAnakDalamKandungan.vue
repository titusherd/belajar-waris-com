          ...
          >
            <div className="sm:col-span-4">
              ...
              <p class="mt-1 text-sm leading-6 text-gray-600">
                Warisan Bagi Anak Dalam Kandungan - Rp 25.000 / tahun
              </p>
            </div>
          </div>
        </div>
...
export default {
  data() {
    return {
      ...
      errorAlert: false,
      price: 25000,
      order_id: "Warisan Bagi Anak Dalam Kandungan",
      status: "",
    };
  },
  methods: {
              ...
              snap.pay(token, {
                onSuccess: (result) => {
                  axios.post("/api/zoho", {
                    ...
                    email: email,
                    apiUrl:
                      "https://flow.zoho.com/839171716/flow/webhook/incoming?zapikey=1001.151f7f826d6344ef2737141a97c5997d.e603b3d4020738dd5bb804a40c30d6ec&isdebug=false",
                  });
